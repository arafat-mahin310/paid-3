...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/arafat-mahin310/Approval3.txt/blob/main/Ap.txt"])

	exit(" [*] FACEBOOK :  Arafat Bin Mahin")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Arafat Bin Mahin")

	subprocess.check_output(["am", "start", "https://m.me/+880192579875"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent.com/arafat-mahin310/Approval3.txt.git').text
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Arafat Mahin

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : V-VIRUX  

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : arafatmahin310

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01925798757
...
\033[1;90m══════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[>_] [Mahin_OLD] : %s/%s -> \033[0;92m [ Mahin-OK:%s ]- \033[0;91m[Mahin-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
